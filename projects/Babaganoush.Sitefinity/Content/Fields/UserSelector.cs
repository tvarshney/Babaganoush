...
namespace Babaganoush.Sitefinity.Content.Fields
{
    ...
    /// Babaganoush.Sitefinity.Content.Fields.UserSelector
    /// </summary>
    [FieldDefinitionElement(typeof(UserSelectorDefinitionElement))]
    public class UserSelector : FieldControl
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="UserSelector" /> class.
        /// </summary>
        public UserSelector()
        {
        }
        ...
        protected virtual Telerik.Sitefinity.Web.UI.Backend.Security.Principals.UserSelector ItemsSelector
        {
            get
            {
                return Container.GetControl<Telerik.Sitefinity.Web.UI.Backend.Security.Principals.UserSelector>("itemsSelector", true);
            }
        }
        ...
        /// </summary>
        public static readonly string layoutTemplatePath = ResourceHelper.ToVirtualPath("Babaganoush.Sitefinity.Content.Fields.UserSelector.ascx");

        /// <summary>
        /// The script reference.
        /// </summary>
        public static readonly string ScriptReference = "Babaganoush.Sitefinity.Content.Fields.UserSelector.js";
